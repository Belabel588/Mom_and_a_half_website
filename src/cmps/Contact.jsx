        ...
        <form className="contact-section-form" onSubmit={handleSubmit}>
          ...
          <div className="contact-section-textbox">
            ...
            <h3 className="contact-section-header">
              לא חייבים להתמודד עם הכול לבד
            </h3>

            <p className="contact-section-text">
              אם משהו בהורות שלכם מעסיק אתכם, מבלבל אתכם או פשוט מרגיש מורכב — אני כאן
              כדי לחשוב איתכם. לפעמים שינוי מתחיל דווקא מעצירה קטנה. משיחה. מהקשבה.
              <br />
